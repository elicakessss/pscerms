...
@section('title', 'Edit Profile - PSCERMS Student')
...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('student.account.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2 px-4 rounded-lg flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <form action="{{ route('student.account.update') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <textarea id="description"
                          ...
                          rows="4"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                          placeholder="Additional information about yourself">{{ old('description', $student->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden mt-6">
        ...
        <form action="{{ route('student.account.update_password') }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
