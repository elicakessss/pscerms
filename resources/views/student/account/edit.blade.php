...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('student.account.update') }}" enctype="multipart/form-data" class="p-6">
            @csrf
            @method('PUT')
    ...
    <div class="bg-white rounded-lg shadow mt-6">
        ...
        <!-- Form -->
        <form method="POST" action="{{ route('student.account.update_password') }}" class="p-6">
            @csrf
            @method('PUT')
