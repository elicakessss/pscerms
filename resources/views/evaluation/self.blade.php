...
@section('page-title', 'Self Evaluation')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6 mb-6">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h3 class="font-semibold text-gray-800">{{ auth()->user()->first_name ?? 'John' }} {{ auth()->user()->last_name ?? 'Doe' }}</h3>
                    <p class="text-sm text-gray-600">{{ auth()->user()->id_number ?? 'ID-2024-001' }}</p>
    ...
    <form action="{{ route('student.evaluation.store') }}" method="POST" id="evaluationForm">
        ...
        <!-- Domain 2: Paulinian Leadership as a Life of Service (Strand 1 and Strand 3) -->
